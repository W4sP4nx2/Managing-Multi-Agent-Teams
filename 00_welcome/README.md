# Workspace Map: Managing Multi-Agent Teams

This file is the workspace map and asset inventory. The GitHub repository front page now uses the root [README.md](../README.md) as the learner-facing course overview.

The workspace contains a complete training material set that moves learners from single-agent prompting to governed, type-safe, multi-agent systems.
